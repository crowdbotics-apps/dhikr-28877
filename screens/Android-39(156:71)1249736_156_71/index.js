  ...
  render = () => (
    ...
    >
      ...
      <TouchableOpacity
        ...
        style={styles.TouchableOpacity_156_75}
        onPress={() =>
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_156_78}
      />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f103/ea97/44b73a79f4787054168e5cde71e36d1b"
        }}
        style={styles.ImageBackground_156_80}
      />
    </ScrollView>
  )
}
