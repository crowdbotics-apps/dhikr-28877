  ...
  render = () => (
    ...
    >
      ...
      <TouchableOpacity
        ...
        style={styles.TouchableOpacity_144_84}
        onPress={() =>
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_144_87}
      />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/63b4/6d51/cd9f7654e2f2f0f34195c29bbfdd28ce"
        }}
        style={styles.ImageBackground_146_89}
      />
    </ScrollView>
  )
}
