  ...
  render = () => (
    ...
    >
      ...
      <TouchableOpacity
        ...
        style={styles.TouchableOpacity_116_8}
        onPress={() =>
      ...
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/3310/ce5e/f98ca1bfbc42dcb1770ee23dd207c392"
        }}
        style={styles.ImageBackground_116_2}
      />
    </ScrollView>
  )
}
