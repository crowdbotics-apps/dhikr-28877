  ...
  render = () => (
    ...
    >
      ...
      <TouchableOpacity
        ...
        style={styles.TouchableOpacity_144_64}
        onPress={() =>
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_144_67}
      />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/db79/00ac/c73da39367e9db5b0ebe6c5cb1a66c19"
        }}
        style={styles.ImageBackground_144_69}
      />
    </ScrollView>
  )
}
