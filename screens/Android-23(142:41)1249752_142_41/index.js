  ...
  render = () => (
    ...
    >
      ...
      <TouchableOpacity
        ...
        style={styles.TouchableOpacity_142_45}
        onPress={() =>
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_142_48}
      />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/a856/1c4d/e3ccc9b680997a108c8ea3ad046877d5"
        }}
        style={styles.ImageBackground_142_59}
      />
    </ScrollView>
  )
}
