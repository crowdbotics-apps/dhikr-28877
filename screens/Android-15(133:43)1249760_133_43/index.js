  ...
  render = () => (
    ...
    >
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_133_47}
      />
      <TouchableOpacity
        source={{
          uri:
        ...
        style={styles.TouchableOpacity_133_48}
        onPress={() =>
      ...
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/314c/793f/c7d650f819d730b3f730659a8a9e23be"
        }}
        style={styles.ImageBackground_133_52}
      />
    </ScrollView>
  )
}
