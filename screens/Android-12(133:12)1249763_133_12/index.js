  ...
  render = () => (
    ...
    >
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_133_16}
      />
      <TouchableOpacity
        source={{
          uri:
        ...
        style={styles.TouchableOpacity_133_17}
        onPress={() =>
      ...
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/5779/9196/0cecc33b4fc12278e55fe0e36622bf69"
        }}
        style={styles.ImageBackground_133_31}
      />
    </ScrollView>
  )
}
