  ...
  render = () => (
    ...
    >
      ...
      <TouchableOpacity
        ...
        style={styles.TouchableOpacity_137_6}
        onPress={() =>
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_137_9}
      />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/c17e/79f8/ee5ea3aeb3a080e945c6ab1417783c79"
        }}
        style={styles.ImageBackground_137_11}
      />
    </ScrollView>
  )
}
