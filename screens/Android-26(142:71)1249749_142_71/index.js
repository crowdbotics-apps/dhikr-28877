  ...
  render = () => (
    ...
    >
      ...
      <TouchableOpacity
        ...
        style={styles.TouchableOpacity_142_75}
        onPress={() =>
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_142_78}
      />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/0a48/28ef/e702fe2da41302e81fec8abaf8b718ac"
        }}
        style={styles.ImageBackground_142_80}
      />
    </ScrollView>
  )
}
