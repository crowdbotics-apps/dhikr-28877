  ...
  render = () => (
    ...
    >
      ...
      <TouchableOpacity
        ...
        style={styles.TouchableOpacity_157_7}
        onPress={() =>
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_157_10}
      />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/98d0/904d/61d6adf1d6317be058e9f6b5d8763af2"
        }}
        style={styles.ImageBackground_157_11}
      />
    </ScrollView>
  )
}
