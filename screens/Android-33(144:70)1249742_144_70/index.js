  ...
  render = () => (
    ...
    >
      ...
      <TouchableOpacity
        ...
        style={styles.TouchableOpacity_144_74}
        onPress={() =>
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_144_77}
      />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/2172/7420/6be82a219e4dfff41ad85dba70e2ce28"
        }}
        style={styles.ImageBackground_144_79}
      />
    </ScrollView>
  )
}
