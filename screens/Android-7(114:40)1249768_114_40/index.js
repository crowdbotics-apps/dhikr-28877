  ...
  render = () => (
    ...
    >
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_114_44}
      />
      <TouchableOpacity
        source={{
          uri:
        ...
        style={styles.TouchableOpacity_114_45}
        onPress={() =>
      ...
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/6b24/a2e5/8ba4d994d8e2a728260f31c14d2a1c23"
        }}
        style={styles.ImageBackground_114_49}
      />
    </ScrollView>
  )
}
