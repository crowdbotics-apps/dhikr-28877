  ...
  render = () => (
    ...
    >
      ...
      <TouchableOpacity
        ...
        style={styles.TouchableOpacity_139_16}
        onPress={() =>
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_139_19}
      />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/6b83/f20e/b455436058c4f9cec62949d28296d0e2"
        }}
        style={styles.ImageBackground_141_20}
      />
    </ScrollView>
  )
}
