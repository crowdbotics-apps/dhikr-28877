  ...
  render = () => (
    ...
    >
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_133_26}
      />
      <TouchableOpacity
        source={{
          uri:
        ...
        style={styles.TouchableOpacity_133_27}
        onPress={() =>
      ...
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/2701/5075/d9e4914a96b42ef238474be4d586197e"
        }}
        style={styles.ImageBackground_133_32}
      />
    </ScrollView>
  )
}
