  ...
  render = () => (
    ...
    >
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_133_37}
      />
      <TouchableOpacity
        source={{
          uri:
        ...
        style={styles.TouchableOpacity_133_38}
        onPress={() =>
      ...
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/c3f9/1832/8b3fe73e211fc7d697f60bfcc54b9e40"
        }}
        style={styles.ImageBackground_133_42}
      />
    </ScrollView>
  )
}
