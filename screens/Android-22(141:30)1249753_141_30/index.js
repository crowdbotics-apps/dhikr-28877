  ...
  render = () => (
    ...
    >
      ...
      <TouchableOpacity
        ...
        style={styles.TouchableOpacity_141_34}
        onPress={() =>
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_141_37}
      />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/6d28/b414/fb2ea56ab8682e34bcc66533b5fe4a59"
        }}
        style={styles.ImageBackground_141_39}
      />
    </ScrollView>
  )
}
