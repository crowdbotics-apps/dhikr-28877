  ...
  render = () => (
    ...
    >
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_118_6}
      />
      <TouchableOpacity
        source={{
          uri:
        ...
        style={styles.TouchableOpacity_118_7}
        onPress={() =>
      ...
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/6d3c/6c16/c700edfcd9cbd8f55cbf6e3891844e2b"
        }}
        style={styles.ImageBackground_118_11}
      />
    </ScrollView>
  )
}
